...
<body bgcolor="black">
    ...
    <div class="news-container">
        ...
        <article class="news-card">
                <div class="news-card-image" style="background-image: url('img/programfore.png');">
        ...
        <!-- Segundo card -->
        <article class="news-card">
<div class="news-card-image" style="background-image: url('img/programfore2.png'); background-position: center top;">
