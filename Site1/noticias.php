...
<body bgcolor="black">
    ...
    <h1 class="news-section-title">Notícias</h1>

    <div class="news-container">
        <!-- Primeiro card -->
        <article class="news-card">
            <div class="news-card-image" style="background-image: linear-gradient(135deg, #1a1a1a, #2d2d2d), url('https://via.placeholder.com/400x200/f4fe08/000000?text=ESPORTS');">
                <div class="news-category">HISTÓRIA</div>
                <div class="news-date">20/09/2025</div>
            </div>
            <div class="news-content">
                <h2 class="news-title">Como tudo começou</h2>
                <p class="news-description">
                    No início, quatro programadores visionários – Luís, Luiz, Marcelo e Miguel – uniram suas paixões e talentos com um objetivo comum: criar um jogo verdadeiramente incrível. Movidos por uma centelha de criatividade e um desejo inabalável de inovar, eles mergulharam em um projeto ambicioso...
                </p>
            </div>
        </article>
        ...
        <!-- Segundo card -->
        <article class="news-card">
            <div class="news-card-image" style="background-image: linear-gradient(135deg, #1a1a1a, #2d2d2d), url('https://via.placeholder.com/400x200/f4fe08/000000?text=COMUNIDADE');">
                <div class="news-category">COMUNIDADE</div>
                <div class="news-date">19/09/2025</div>
            </div>
            <div class="news-content">
                <h2 class="news-title">De onde vem nossas ideias</h2>
                <p class="news-description">
                    O processo foi uma mistura de sessões de brainstorming caóticas e momentos de inspiração silenciosa. De onde vêm as ideias? Para eles, vinham de todo lugar: de uma conversa à toa, de um filme antigo, de uma memória de infância ou até de um erro de código...
                </p>
            </div>
        </article>
    </div>
