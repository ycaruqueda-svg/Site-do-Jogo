...
<body bgcolor="ycaruqueda-svg">
    <h1>Bem vindo à página de login</h1><br>
       <a href="login.php" class="cta-button">Faça login</a>
       <br>
       <br>

       <a href="registro.php" class="cta-button">Registre-se</a>
